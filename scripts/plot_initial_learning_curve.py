...
n_train = [50, 100, 200, 500, 1000]
force_mae = [3.9876, 2.8884, 1.8346, 1.1501, 0.7925]
energy_mae = [1.4213, 1.2807, 0.7284, 0.3721, 0.2563]
...
plt.ylabel("MAE")
plt.title("Learning curve on MD17 ethanol")
